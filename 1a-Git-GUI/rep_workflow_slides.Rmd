...
---
# Workflow & General Coding Suggestions 
...
5- Fork repo `test2`, and clone it into your machine.  
6- Edit fields of name, and birth date.   
7- Save, commit and push.   
8- Create your first pull request.   
9- Let's see if I can manage all those PR very quickly.     
10- All in the same project!  
